...
public class PaymentService {
        ...
        try {
            ...
            if (successful) {
                ...
                if (isExpired) {
                    ...
                    // tạo refund với status là PENDING
    ...
    public void processRefund(Long refundId) {
        ...
        refund.ensurePending();

        // Lấy thông tin Payment gốc
        Payment payment = refund.getPayment();

        // Build RefundCommand từ Refund + Payment
        RefundCommand command = new RefundCommand(
                "RF" + refund.getId(),           // refundReference
                payment.getPaymentReference(),    // paymentReference (vnp_TxnRef gốc)
                payment.getProviderTransactionNo(), // vnp_TransactionNo gốc
                refund.getAmount(),
                payment.getCreatedAt(),           // thời gian tạo payment gốc
                "system"                          // createdBy
        );
